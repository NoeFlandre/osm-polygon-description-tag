...
def test_stats_block_is_an_exact_contract_for_non_default_values() -> None:
    stats = {
        ...
        "area_m2_mean_m2": 80.0,
        "area_m2_min_m2": 0.5,
        "area_m2_p25_m2": 10.0,
        "area_m2_median_m2": 50.0,
        "area_m2_p75_m2": 100.0,
        "area_m2_max_m2": 2_000_000.0,
        "dataset_bbox": [-10.0, -20.0, 30.0, 40.0],
        "geometry_vertices_total": 2_000,
        "geometry_rings_total": 500,
        "geometry_holes_total": 20,
        "multipolygon_components_total": 120,
